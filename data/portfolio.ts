  ...
  projects: [
    {
      ...
      description: {
        en: "A comprehensive dashboard for managing online store inventory and sales.",
        ja: "オンラインストアの在庫と売上を管理するための包括的なダッシュボード。",
      },
    ...
    },
    {
      ...
      description: {
        ...
        ja: "リアルタイム更新機能を備えたコラボレーションタスク管理ツール。",
      },
    ...
    },
    {
      ...
      description: {
        ...
        ja: "私のスキルとプロジェクトを紹介する個人的なポートフォリオサイト。",
      },
